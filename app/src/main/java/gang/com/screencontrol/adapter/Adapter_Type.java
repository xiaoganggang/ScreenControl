...
public class Adapter_Type extends RecyclerView.Adapter<Adapter_Type.viewholder> {
    ...
    private Adapter_Type.OnRecyclerViewItemClickListener mOnItemClickListener = null;


    //最后给外面的调用者，定义一个设置Listener的方法（）
    public void setOnItemClickListener(Adapter_Type.OnRecyclerViewItemClickListener listener) {
        this.mOnItemClickListener = listener;
    }

    //一个构造函数
    public Adapter_Type(Context context, List<Type> mDates) {
    ...
    public viewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Adapter_Type.viewholder vh = new Adapter_Type.viewholder(view);
        return vh;
    }
